      ...
      <div className="p-2 border rounded-lg grid grid-cols-2">
          ...
          <div className="flex justify-end gap-x-2">
            <button className="p-2 rounded-lg border border-yellow-300">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-pencil-square text-yellow-500" // Use className here
                viewBox="0 0 16 16"
              >
            ...
            <button
              ...
              onClick={() => handleDelete(props.id)} // Ensure the ID is passed correctly
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        {Object.entries(props)
          ...
          .map(([key, value], index) => {
            ...
            return (
              <div key={index}>
                <label htmlFor="" className="text-theme-content-secondary text-sm">
                  {label}
                </label>
                <p className="text-theme-content">
